...
//Wall constructor
function StormWall() {
    let throttledResize = throttle(function () {
...
StormWall.prototype.createPanel = function () {
    let elementFactory = function (element, className, attributes) {
...
StormWall.prototype.initButtons = function () {
    let templates = ['<button class="js-wall-button-close icon-cancel" aria-label="close"></button>',
                        '<button class="js-wall-button-previous icon-left-open-1" aria-label="previous"></button>',
                        '<button class="js-wall-button-next icon-right-open-1" aria-label="next"></button>'
    ].join('');
